...
$urlHeader = $_SERVER['REQUEST_URI'];
if (strpos($urlHeader, 'listeVoyage.php') !== false || strpos($urlHeader, 'ajouter.php') !== false) {
    $btnConnexion = '<a href="asset/php/methodeClass/logout.php" id="btnConnexion">Déconnexion</a>';
} elseif (strpos($urlHeader, '') !== false || strpos($urlHeader, 'index.php') !== false) {
    $btnConnexion = '<a href="../index.php" id="btnConnexion">Connexion</a>';
}

$templateHeader = '

<header>
    <svg id="logo" version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    ...
    <nav>
        <a>Acceuil</a>
        <a>Adhérez !</a>
        <a>Séjours 2 pour 1</a>
        <a>Parrainez tous vos amis !</a>
        <a>Contact</a>
        ' . $btnConnexion . '
    </nav>
</header>
